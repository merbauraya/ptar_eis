...
var render_chartByState = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartState}",
  listeners: ['${p:yearParam}','${p:categoryParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataYtdByState",
    path: "/public/ptar/dashboard/perjawatan/default.cda",
    height: 400,
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperjawatan%3Amengikut_negeri.wcdf/generatedContent';
    window.location = drillDownurl + "?negeri="+state + "&tahun="+ year;
