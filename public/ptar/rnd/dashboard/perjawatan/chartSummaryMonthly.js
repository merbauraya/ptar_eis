...
var render_chartSummaryMonthly = {
  type: "cccBarChart",
  name: "render_chartSummaryMonthly",
  priority: 2,
  parameters: [["yearParam","yearParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartMonthly}",
...
var myself = this;
  ...
  chartDefinition:  {
    dataAccessId: "dataSummaryMonthly",
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperjawatan%3Amengikut_bulan.wcdf/generatedContent';
...
cgg.render(render_chartSummaryMonthly);
