...
var render_chartTop10 = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["periodParam","periodParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10}",
  listeners: ['${p:yearParam}','${p:monthParam}','${p:categoryParam}','${p:periodParam}'],
  chartDefinition:  {
    dataAccessId: "dataTop10",
    path: "/public/ptar/dashboard/perjawatan/mengikut_bulan.cda",
    height: 350,
