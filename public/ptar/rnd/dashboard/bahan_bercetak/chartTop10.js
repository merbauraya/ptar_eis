...
var render_chartTop10 = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["top10Param","top10Param"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10}",
  listeners: ['${p:yearParam}','${p:top10Param}','${p:ytdPeriodParam}'],
  chartDefinition:  {
