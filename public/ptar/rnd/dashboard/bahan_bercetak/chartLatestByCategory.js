...
var render_chartLatestByCategory = {
  type: "cccBarChart",
  name: "render_chartLatestByCategory",
  priority: 5,
  parameters: [["stateParam","stateParam"],["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartLatestByCategory}",
  listeners: ['${p:stateParam}','${p:yearParam}','${p:measureParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataLatestByCategory",
    path: "/public/ptar/dashboard/bahan_bercetak/mengikut_negeri.cda",
    height: 400,
...
cgg.render(render_chartLatestByCategory);
