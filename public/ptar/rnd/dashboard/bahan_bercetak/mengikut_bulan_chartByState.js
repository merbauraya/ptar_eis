...
var render_chartByState = {
  ...
  priority: 4,
  parameters: [["yearParam","yearParam"],["periodParam","periodParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartByState}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:measureParam}','${p:periodParam}'],
  chartDefinition:  {
