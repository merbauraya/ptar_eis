...
var render_chartTop40 = {
  ...
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["top10Param","top10Param"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "htmlTop10",
  listeners: ['${p:yearParam}','${p:measureParam}','${p:top10Param}','${p:ytdPeriodParam}','${p:mediumParam}'],
  chartDefinition:  {
