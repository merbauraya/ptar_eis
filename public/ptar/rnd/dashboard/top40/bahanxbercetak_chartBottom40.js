...
var render_chartBottom40 = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["top10Param","top10Param"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlBottom10}",
  listeners: ['${p:categoryParam}','${p:yearParam}','${p:measureParam}','${p:top10Param}','${p:ytdPeriodParam}','${p:mediumParam}'],
  chartDefinition:  {
    dataAccessId: "dataBottom40",
    path: "/public/ptar/dashboard/top40/bahanxbercetak.cda",
    height: 1000,
