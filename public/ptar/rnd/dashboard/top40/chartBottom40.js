...
var render_chartBottom40 = {
  type: "cccBarChart",
  name: "render_chartBottom40",
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["topBottom10Measure","topBottom10Measure"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlBottom10}",
  listeners: ['${p:categoryParam}','${p:yearParam}','${p:measureParam}','${p:topBottom10Measure}','${p:ytdPeriodParam}','${p:mediumParam}'],
  chartDefinition:  {
    dataAccessId: "dataBottom40",
    path: "/public/ptar/dashboard/top40/repositori.cda",
    height: 1000,
    ...
    var libraryParam = scene.vars.category.value;
    ...
    window.location = drillDownurl + "?perpustakaan="+libraryParam + "&tahun="+ year;
...
cgg.render(render_chartBottom40);
