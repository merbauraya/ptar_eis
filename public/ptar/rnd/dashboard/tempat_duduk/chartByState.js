...
var render_chartByState = {
  ...
  chartDefinition:  {
    ...
    path: "/public/ptar/dashboard/tempat_duduk/mengikut_kategori.cda",
    height: 500,
    ...
    var negeri = scene.vars.category.value;
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Amembership%3Amengikut_negeri.wcdf/generatedContent';
    window.location = drillDownurl + "?negeri="+negeri + "&tahun="+ year;
