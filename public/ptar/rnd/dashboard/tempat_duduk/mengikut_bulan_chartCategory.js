...
var render_chartCategory = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["quarterMonthParam","quarterMonthParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlCategory}",
  listeners: ['${p:yearParam}','${p:monthParam}','${p:quarterMonthParam}'],
  chartDefinition:  {
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Atempat_duduk%3Amengikut_kategori.wcdf/generatedContent';
    window.location = drillDownurl + "?kategori="+category + "&tahun="+ year;
