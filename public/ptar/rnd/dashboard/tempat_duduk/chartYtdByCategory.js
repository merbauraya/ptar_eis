...
var render_chartYtdByCategory = {
  type: "cccBarChart",
  name: "render_chartYtdByCategory",
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"]],
  executeAtStart: true,
  htmlObject: "htmlYtdByCategory",
  listeners: ['${p:yearParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataYtdByCategory",
    path: "/public/ptar/dashboard/tempat_duduk/ringkasan.cda",
    height: 400,
    extensionPoints: [["baseAxisLabel_textAngle","-0.0"],["baseAxisLabel_textAlign","right"],["label_textStyle","#FFF"]],
    colors: [],
    animate: true,
    barOrthoSizeMin: 1.5,
    barSizeMax: 500,
...
cgg.render(render_chartYtdByCategory);
