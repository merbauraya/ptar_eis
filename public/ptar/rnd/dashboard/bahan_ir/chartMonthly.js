...
var render_chartMonthly = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["ptjParam","ptjParam"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartMonthly}",
  listeners: ['${p:yearParam}','${p:ptjParam}','${p:measureParam}','${p:mediumParam}'],
  chartDefinition:  {
