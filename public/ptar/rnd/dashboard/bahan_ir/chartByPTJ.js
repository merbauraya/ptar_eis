...
var render_chartByPTJ = {
  type: "cccBarChart",
  name: "render_chartByPTJ",
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["measureParam","measureParam"],["mediumParam","mediumParam"],["ptjTypeParam","ptjTypeParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartPTJ}",
  listeners: ['${p:yearParam}','${p:mediumParam}','${p:measureParam}','${p:ytdPeriodParam}','${p:ptjTypeParam}'],
  chartDefinition:  {
    dataAccessId: "dataByPTJ",
    path: "/public/ptar/dashboard/bahan_ir/jenis_ptj.cda",
    height: 400,
   ...
   var ptj = encodeURIComponent(scene.vars.category.value);
  // return;
...
//    var state = scene.vars.category.value;
  //  var v = scene.vars.value.value;
   ...
   var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Abahan_ir%3Amengikut_ptj.wcdf/generatedContent';
//    var drilDownurl = 'pentaho/api/repos' ;
    window.location = drillDownurl + "?ptj="+ptj + "&tahun="+ year;
...
("ptjTypeParam", "ptjTypeParam")
;

cgg.render(render_chartByPTJ);
