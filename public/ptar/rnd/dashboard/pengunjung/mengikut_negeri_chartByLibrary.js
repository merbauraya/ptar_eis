...
var render_chartByLibrary = {
  type: "cccBarChart",
  name: "render_chartByLibrary",
  priority: 5,
  parameters: [["stateParam","stateParam"],["yearParam","yearParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartLibrary}",
  listeners: ['${p:categoryParam}','${p:stateParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataByLibrary",
    path: "/public/ptar/dashboard/pengunjung/mengikut_negeri.cda",
    height: 350,
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Apengunjung%3Amengikut_perpustakaan.wcdf/generatedContent';
//    var drilDownurl = 'pentaho/api/repos' ;
    window.location = drillDownurl + "?perpustakaan="+library + "&tahun="+ year;
...
cgg.render(render_chartByLibrary);
