...
var render_chartMonthly = {
  ...
  priority: 5,
  parameters: [["stateParam","stateParam"],["yearParam","yearParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartCategory}",
  listeners: ['${p:stateParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataMonthly",
    path: "/public/ptar/rnd/dashboard/bahan_bercetak/mengikut_negeri.cda",
    height: 300,
