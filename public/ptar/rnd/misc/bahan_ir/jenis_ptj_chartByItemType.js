...
//    var state = scene.vars.category.value;
  //  var v = scene.vars.value.value;
   ...
   var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Abahan_ir%3Ajenis_bahan.wcdf/generatedContent';
...
cgg.render(render_chartByItemType);
