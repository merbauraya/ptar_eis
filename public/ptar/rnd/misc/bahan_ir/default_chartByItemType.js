...
var render_chartByItemType = {
  ...
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartItemType}",
  listeners: ['${p:yearParam}','${p:mediumParam}','${p:measureParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
