...
var render_chartCategory = {
  ...
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["ptjParam","ptjParam"],["measureParam","measureParam"],["mediumParam","mediumParam"],["topBottom10Measure","topBottom10Measure"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartCategory}",
  listeners: ['${p:yearParam}','${p:ptjParam}','${p:measureParam}','${p:mediumParam}','${p:topBottom10Measure}'],
  chartDefinition:  {
    dataAccessId: "dataCategory",
    path: "/public/ptar/dashboard/bahan_ir/mengikut_ptj.cda",
    height: 400,
   ...
   var category = encodeURIComponent(scene.vars.category.value);
  // return;
