...
var render_chartState = {
  ...
  chartDefinition:  {
    dataAccessId: "dataStateYearly",
    path: "/public/ptar/rnd/dashboard/pegunjung.cda",
    height: 350,
    extensionPoints: [["baseAxisLabel_textAngle","-0.8"],["baseAxisLabel_textAlign","right"],["label_textStyle","#262626"],["label_labelLayoutInfo","function (scene)\n{\n    console.log(\"x\");\n    console.log(scene);\n};"],["label_textMargin","-10"]],
    colors: [],
    animate: true,
    barOrthoSizeMin: 1.5,
    barSizeMax: 50,
    ...
    var stateParam = scene.vars.category.value;
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Apengunjung%3Amengikut_negeri.wcdf/generatedContent';
    window.location = drillDownurl + "?negeri="+stateParam + "&tahun="+ year;
