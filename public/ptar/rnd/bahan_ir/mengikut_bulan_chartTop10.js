...
var render_chartTop10 = {
  ...
  priority: 4,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["yearParam","yearParam"],["monthParam","monthParam"],["measureParam","measureParam"],["mediumParam","mediumParam"],["topBottom10Measure","topBottom10Measure"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:ytdPeriodParam}','${p:mediumParam}','${p:measureParam}','${p:topBottom10Measure}'],
  chartDefinition:  {
