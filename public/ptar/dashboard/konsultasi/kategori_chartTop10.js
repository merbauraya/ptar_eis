...
var render_chartTop10 = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["categoryParam","categoryParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  postFetch: function (cdaData) {
    console.log(cdaData);
    // Return modified cda data set
    return cdaData;
} ,
  htmlObject: "${h:htmlTop10}",
  listeners: ['${p:yearParam}','${p:categoryParam}','${p:measureParam}','${p:groupParam}'],
  chartDefinition:  {
    dataAccessId: "dataTop10Library",
    path: "/public/ptar/dashboard/konsultasi/kategori.cda",
    height: 300,
