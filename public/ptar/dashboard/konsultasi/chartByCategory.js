...
var myself = this;
 ...
 ,
  ...
  chartDefinition:  {
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Akonsultasi%3Akategori.wcdf/generatedContent';
//    var drilDownurl = 'pentaho/api/repos' ;
    window.location = drillDownurl + "?kategori="+state + "&tahun="+ year;
    
} 
/*
unction sendParameter(scene)
{ 
    var url='/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard2%3Akonsultasi%3Aperpustakaan.wcdf/generatedContent'; 
