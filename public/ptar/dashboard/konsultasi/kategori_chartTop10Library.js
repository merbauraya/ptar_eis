...
var render_chartTop10Library = {
  type: "cccBarChart",
  name: "render_chartTop10Library",
  priority: 5,
  ...
  postFetch: function(data)
{
  ...
  listeners: ['${p:yearParam}','${p:categoryParam}','${p:groupParam}'],
  chartDefinition:  {
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Apinjaman%3Amengikut_bulan.wcdf/generatedContent';
...
cgg.render(render_chartTop10Library);
