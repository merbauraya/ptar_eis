...
var render_chartQuarterState = {
  type: "cccBarChart",
  name: "render_chartQuarterState",
  priority: 5,
  parameters: [["yearParam","yearParam"],["quarterParam","quarterParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "htmlChartQuarterState",
  listeners: ['${p:yearParam}','${p:quarterParam}','${p:categoryParam}'],
  chartDefinition:  {
    dataAccessId: "dataQuarterState",
    path: "/public/ptar/dashboard/pinjaman/mengikut_suku.cda",
    height: 300,
...
cgg.render(render_chartQuarterState);
