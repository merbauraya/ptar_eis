...
var render_chartTop10 = {
  ...
  priority: 4,
  parameters: [["itemCategoryParam","itemCategoryParam"],["ytdPeriodParam","ytdPeriodParam"],["yearParam","yearParam"],["measureParam","measureParam"],["top10Param","top10Param"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10}",
  listeners: ['${p:top10Param}','${p:measureParam}','${p:itemCategoryParam}','${p:yearParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
