...
var render_chartMonthly = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["libraryParam","libraryParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartMonthly}",
  listeners: ['${p:yearParam}','${p:libraryParam}','${p:measureParam}'],
  chartDefinition:  {
    dataAccessId: "dataLibrary",
