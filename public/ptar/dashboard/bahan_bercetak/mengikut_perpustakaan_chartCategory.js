...
var render_chartCategory = {
  ...
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["libraryParam","libraryParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartCategory}",
  listeners: ['${p:yearParam}','${p:libraryParam}','${p:measureParam}','${p:stateParam}'],
  chartDefinition:  {
    dataAccessId: "dataCategory",
    path: "/public/ptar/dashboard/bahan_bercetak/mengikut_perpustakaan.cda",
    height: 400,
