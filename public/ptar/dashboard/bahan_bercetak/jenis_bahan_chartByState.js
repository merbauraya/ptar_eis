...
var render_chartByState = {
  type: "cccBarChart",
  name: "render_chartByState",
  priority: 4,
  parameters: [["itemCategoryParam","itemCategoryParam"],["ytdPeriodParam","ytdPeriodParam"],["yearParam","yearParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "htmlChartByState",
  listeners: ['${p:measureParam}','${p:itemCategoryParam}','${p:yearParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataItemTypeByState",
    path: "/public/ptar/dashboard/bahan_bercetak/jenis_bahan.cda",
    height: 500,
...
cgg.render(render_chartByState);
