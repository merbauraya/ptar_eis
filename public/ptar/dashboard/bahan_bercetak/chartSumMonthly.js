...
var render_chartSumMonthly = {
  type: "cccBarChart",
  name: "render_chartSumMonthly",
  priority: 5,
  parameters: [["yearParam","yearParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "htmlChartSumMonthly",
  listeners: ['${p:yearParam}','${p:measureParam}'],
  chartDefinition:  {
    dataAccessId: "dataSumMonthly",
   ...
   var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Abahan_bercetak%3Amengikut_bulan.wcdf/generatedContent';
...
cgg.render(render_chartSumMonthly);
