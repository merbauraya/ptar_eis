...
var render_chartState = {
  ...
  chartDefinition:  {
    ...
    baseAxisTicks: true,
    baseAxisTitleFont: "14px sans-serif",
...
//    var state = scene.vars.category.value;
  //  var v = scene.vars.value.value;
   ...
   var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Abahan_bercetak%3Amengikut_negeri.wcdf/generatedContent';
//    var drilDownurl = 'pentaho/api/repos' ;
    window.location = drillDownurl + "?negeri="+state + "&tahun="+ yearParam;
