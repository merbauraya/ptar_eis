...
var render_chartBottom40 = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["ytdPeriodParam","ytdPeriodParam"],["lokasiParam","lokasiParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlBottom10}",
  listeners: ['${p:yearParam}','${p:lokasiParam}','${p:categoryParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataBottom40",
    path: "/public/ptar/dashboard/top40/perjawatan.cda",
    height: 1000,
