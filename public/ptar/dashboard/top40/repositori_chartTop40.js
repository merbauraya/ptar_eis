...
var render_chartTop40 = {
  ...
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"],["topBottom10Measure","topBottom10Measure"],["measureParam","measureParam"],["mediumParam","mediumParam"]],
  executeAtStart: true,
  htmlObject: "htmlTop10",
  listeners: ['${p:yearParam}','${p:measureParam}','${p:topBottom10Measure}','${p:ytdPeriodParam}','${p:mediumParam}'],
  chartDefinition:  {
