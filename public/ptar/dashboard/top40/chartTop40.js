...
var render_chartTop40 = {
  type: "cccBarChart",
  name: "render_chartTop40",
  priority: 5,
  parameters: [["yearParam","yearParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "htmlTop10",
  listeners: ['${p:categoryParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataTop40",
    path: "/public/ptar/dashboard/top40/perbelanjaan.cda",
    height: 1000,
