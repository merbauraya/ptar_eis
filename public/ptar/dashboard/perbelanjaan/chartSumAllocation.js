...
var render_chartSumAllocation = {
  type: "cccBarChart",
  name: "render_chartSumAllocation",
  priority: 5,
  parameters: [["yearParam","yearParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlSumAllocation}",
  listeners: ['${p:typeParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataSumAllocation",
    ...
    var typeParam = scene.vars.category.value;
    ...
    window.location = drillDownurl + "?kategoriBahan="+typeParam + "&tahun="+ year;
...
cgg.render(render_chartSumAllocation);
