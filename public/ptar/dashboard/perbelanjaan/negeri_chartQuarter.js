...
var render_chartQuarter = {
  ...
  executeAtStart: true,
  htmlObject: "${h:htmlChartQuarter}",
  listeners: ['${p:categoryParam}','${p:stateParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataQuarter",
    path: "/public/ptar/dashboard/perbelanjaan/negeri.cda",
    height: 350,
    extensionPoints: [],
    colors: [],
    activeSliceRadius: "5%",
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperbelanjaan%3Asuku.wcdf/generatedContent';
