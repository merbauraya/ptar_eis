...
var render_chartAllocByCategory = {
  type: "cccBarChart",
  name: "render_chartAllocByCategory",
  priority: 4,
  parameters: [["periodParam","periodParam"],["yearParam","yearParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlAllocCategory}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:measureParam}'],
  chartDefinition:  {
    dataAccessId: "dataAllocationByCategory",
...
cgg.render(render_chartAllocByCategory);
