...
var render_chartAllocation = {
  type: "cccBarChart",
  name: "render_chartAllocation",
  priority: 5,
  parameters: [["yearParam","yearParam"],["libraryParam","libraryParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlAllocationByType}",
  listeners: ['${p:yearParam}','${p:libraryParam}','${p:stateParam}','${p:categoryParam}'],
  chartDefinition:  {
    dataAccessId: "dataAllocationByType",
    path: "/public/ptar/dashboard/perbelanjaan/perpustakaan.cda",
    height: 300,
    ...
    var itemType = scene.vars.category.value;
   ...
   // var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperbelanjaan%3Aperuntukan.wcdf/generatedContent';
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperbelanjaan%3Abahan.wcdf/generatedContent';

    window.location = drillDownurl + "?kategoriBahan="+ encodeURI(itemType) + "&tahun="+ year;
...
cgg.render(render_chartAllocation);
