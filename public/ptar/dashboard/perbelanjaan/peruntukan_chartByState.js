...
var render_chartByState = {
  ...
  priority: 4,
  parameters: [["itemCategoryParam","itemCategoryParam"],["yearParam","yearParam"],["measureParam","measureParam"]],
  executeAtStart: true,
  htmlObject: "htmlChartByState",
  listeners: ['${p:measureParam}','${p:itemCategoryParam}','${p:yearParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataByState",
    path: "/public/ptar/dashboard/perbelanjaan/peruntukan.cda",
    height: 500,
...
//    var state = scene.vars.category.value;
  //  var v = scene.vars.value.value;
   ...
   var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Aperbelanjaan%3Anegeri.wcdf/generatedContent';
