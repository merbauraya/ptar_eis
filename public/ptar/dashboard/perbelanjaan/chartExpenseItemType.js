...
var render_chartExpenseItemType = {
  ...
  chartDefinition:  {
    ...
    var kategoriBahan = scene.vars.category.value;
    ...
    window.location = drillDownurl + "?kategoriBahan="+kategoriBahan + "&tahun="+ year;
...
cgg.render(render_chartExpenseItemType);
