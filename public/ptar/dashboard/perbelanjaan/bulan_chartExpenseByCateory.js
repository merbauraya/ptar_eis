...
var render_chartExpenseByCateory = {
  type: "cccBarChart",
  name: "render_chartExpenseByCateory",
  priority: 4,
  parameters: [["periodParam","periodParam"],["yearParam","yearParam"],["typeParam","typeParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlExpChartCategory}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:measureParam}','${p:periodParam}','${p:typeParam}'],
  chartDefinition:  {
    dataAccessId: "dataExpenseByCategory",
...
cgg.render(render_chartExpenseByCateory);
