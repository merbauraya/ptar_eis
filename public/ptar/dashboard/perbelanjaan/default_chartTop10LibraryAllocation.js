...
var render_chartTop10LibraryAllocation = {
  type: "cccBarChart",
  name: "render_chartTop10LibraryAllocation",
  priority: 5,
  parameters: [["yearParam","yearParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10Allocation}",
  listeners: ['${p:typeParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataTop10LibraryAllocation",
    path: "/public/ptar/dashboard/perbelanjaan/default.cda",
    height: 300,
...
cgg.render(render_chartTop10LibraryAllocation);
