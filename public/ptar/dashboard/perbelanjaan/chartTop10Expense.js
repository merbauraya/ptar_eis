...
var render_chartTop10Expense = {
  type: "cccBarChart",
  name: "render_chartTop10Expense",
  priority: 5,
  parameters: [["yearParam","yearParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlTop10LibraryExpense}",
  listeners: ['${p:typeParam}','${p:yearParam}'],
  chartDefinition:  {
    dataAccessId: "dataTop10ExpenseByLibrary",
...
cgg.render(render_chartTop10Expense);
