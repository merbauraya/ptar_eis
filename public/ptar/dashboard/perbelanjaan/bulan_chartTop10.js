...
var render_chartTop10 = {
  ...
  priority: 4,
  parameters: [["yearParam","yearParam"],["periodParam","periodParam"],["top10Param","top10Param"],["typeParam","typeParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlExpTop10}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:top10Param}','${p:periodParam}','${p:typeParam}'],
  chartDefinition:  {
