...
var render_chartItemTypeVolume = {
  type: "cccPieChart",
  name: "render_chartItemTypeVolume",
  priority: 5,
  parameters: [["ytdPeriodParam","ytdPeriodParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlChartVolume}",
  listeners: ['${p:monthParam}','${p:yearParam}','${p:ytdPeriodParam}'],
  chartDefinition:  {
    dataAccessId: "dataItemTypeNaskah",
...
cgg.render(render_chartItemTypeVolume);
