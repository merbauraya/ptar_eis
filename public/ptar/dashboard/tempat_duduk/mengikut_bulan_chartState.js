...
var render_chartState = {
  ...
  priority: 5,
  parameters: [["yearParam","yearParam"],["quarterMonthParam","quarterMonthParam"],["categoryParam","categoryParam"]],
  executeAtStart: true,
  htmlObject: "${h:htmlState}",
  listeners: ['${p:yearParam}','${p:monthParam}','${p:quarterMonthParam}','${p:categoryParam}'],
  chartDefinition:  {
    dataAccessId: "dataByState",
    path: "/public/ptar/dashboard/tempat_duduk/mengikut_bulan.cda",
    height: 400,
    ...
    var drillDownurl = '/pentaho/api/repos/%3Apublic%3Aptar%3Adashboard%3Atempat_duduk%3Amengikut_negeri.wcdf/generatedContent';
...
cgg.initParameter
("yearParam", "yearParam")
("quarterMonthParam", "quarterMonthParam")
